...
<div class="max-w-lg w-full bg-white p-8 rounded shadow-lg mx-auto">
    ...
    <form method="post" class="space-y-4">
        ...
        <div class="flex gap-2">
            <input type="text" id="code" name="attendance_code" maxlength="6" class="w-full border p-3 rounded text-center font-bold uppercase" required>
