...
<div class="max-w-2xl w-full mx-auto p-4">
    ...
    <table class="w-full bg-white rounded shadow">
        <thead class="bg-gray-200">
            <tr><th class="p-3">日付</th><th class="p-3">授業</th><th class="p-3">状況</th></tr>
        </thead>
        <tbody>
            <?php foreach ($history as $row): ?>
            <tr class="border-b text-center"><td class="p-3"><?= $row['DATE'] ?></td><td class="p-3"><?= $row['CLASS_NAME'] ?></td><td class="p-3 text-green-600 font-bold"><?= $row['ATTENDANCE_STATUS'] ?></td></tr>
            <?php endforeach; ?>
        </tbody>
    </table>
