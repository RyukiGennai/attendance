...
$list = [];
if ($class) {
    $stmt2 = $pdo->prepare("SELECT a.*, u.NAME, u.STUDENT_NUMBER, c.CLASS_NAME 
...
<div class="max-w-4xl mx-auto p-4">
    ...
    <table class="w-full bg-white border-collapse shadow">
        ...
        <tbody>
            ...
            <?php endforeach; ?>
            <?php if(!$list): ?><tr><td colspan="4" class="p-10 text-center text-gray-400">本日の出席データはありません</td></tr><?php endif; ?>
        </tbody>
    </table>
</div>